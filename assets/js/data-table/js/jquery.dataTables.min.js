...
iStateDuration:7200,iDeferLoading:null,iDisplayLength:10,iDisplayStart:0,iTabIndex:0,oClasses:{},oLanguage:{oAria:{sSortAscending:": activate to sort column ascending",sSortDescending:": activate to sort column descending"},oPaginate:{sFirst:"Awal",sLast:"Akhir",sNext:"Lanjut",sPrevious:"Sebelum"},sEmptyTable:"Tidak ada data yang bisa ditampilkan",sInfo:"Menampilkan _START_ - _END_ dari _TOTAL_ baris",sInfoEmpty:"Menampilkan 0 - 0 dari 0 baris",sInfoFiltered:"(filtered from _MAX_ total hasil)",sInfoPostFix:"",sDecimal:"",
sThousands:",",sLengthMenu:"Tampilkan _MENU_ baris",sLoadingRecords:"Loading...",sProcessing:"Proses...",sSearch:"Cari:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"Tidak ada data yang sesuai"},oSearch:g.extend({},p.models.oSearch),sAjaxDataProp:"data",sAjaxSource:null,sDom:"lfrtip",searchDelay:null,sPaginationType:"simple_numbers",sScrollX:"",sScrollXInner:"",sScrollY:"",sServerMethod:"GET",renderer:null};V(p.defaults);p.defaults.column={aDataSort:null,iDataSort:-1,asSorting:["asc","desc"],bSearchable:!0,
